...
STATUS_ID_MAP = {
    1: STATUS_SUBMITTED,
    2: STATUS_EXTRACTING,
    3: STATUS_READY_FOR_BOT_INTERVIEW,
    4: STATUS_BOT_INTERVIEW,
    5: STATUS_READY_FOR_CLASSIFICATION,
...
class DocumentStatus(str, Enum):
    ...
    READY_FOR_BOT_INTERVIEW = STATUS_READY_FOR_BOT_INTERVIEW
    BOT_INTERVIEW = STATUS_BOT_INTERVIEW
    READY_FOR_RECRUIT = STATUS_READY_FOR_RECRUIT
    READY_FOR_CLASSIFICATION = STATUS_READY_FOR_CLASSIFICATION
